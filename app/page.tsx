...
import { MotionContainer, MotionItem } from "../components/motion/MotionPrimitives";
...
export default function Home() {
  return (
    <AppShell>
      <MotionContainer className="grid min-w-0 max-w-full gap-4 xl:grid-cols-[minmax(0,1fr)_360px] xl:gap-6">
        ...
        <MotionItem className="min-w-0 space-y-4 xl:space-y-6 xl:pt-0">
          <Card
